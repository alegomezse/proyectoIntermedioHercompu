...
plot 'datosTranspuesta.txt' using 2:11 w lp, 'datosTransArmadillo.txt' using 2:11 w lp,'datosEigentranspuesta.txt' using 2:11 w lp,'datosTranspuestaBloking.txt' using 2:11 w lp
...
plot 'datosTranspuestaO3.txt' using 2:11 w lp, 'datosTransArmadilloO3.txt' using 2:11 w lp,'datosEigentranspuestaO3.txt' using 2:11 w lp,'datosTranspuestaBlokingO3.txt' using 2:11 w lp
